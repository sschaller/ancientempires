...
class Loader extends Phaser.State {
    ...
    preload() {
        ...
        this.game.load.bitmapFont("font7", "assets/font.png", "assets/font.xml");
        this.game.load.binary("data", "assets/1.pak", function(key: string, data: any): Uint8Array {
            return new Uint8Array(data);
        });
        this.game.load.binary("lang", "assets/lang.dat", function(key: string, data: any): Uint8Array {
            return new Uint8Array(data);
        });
    }
