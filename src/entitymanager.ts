...
class EntityManager {
    ...
    constructor(map: Tilemap, entity_group: Phaser.Group, selection_group: Phaser.Group, interaction_group: Phaser.Group, anim_group: Phaser.Group, delegate: EntityManagerDelegate) {
